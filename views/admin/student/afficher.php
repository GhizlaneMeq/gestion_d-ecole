...
<?php
include '../../../controllers/admin/student/afficher.php';
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content">
        <div class="row tab">
            <div class="col-xl-6 col-md-6 mb-5" data-aos="fade-right" data-aos-duration="1500">
                <a href="ajouter.php" class="btn btn-success mb-3" data-aos="fade-down" data-aos-duration="1500">add student</a>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="modifier.php?id=<?= $rows['student_id'] ?>" class="link-dark"><i class='bx bxs-pencil fs-5 me-3'></i></a>
                                                <a href="../../../controllers/admin/student/delete.php?id=<?= $rows['student_id'] ?>" class="link-danger" onclick="return confirm('Are you sure you want to delete this Student?');"><i class='bx bxs-user-x fs-5'></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    endwhile;
