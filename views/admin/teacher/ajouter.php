...
<body>
  ...
  <div class="content">
    <div class="form-container">
      ...
      <form action="../../../controllers/admin/teacher/ajouter.php" method="post" enctype="multipart/form-data">
        ...
        <br>
        <button type="submit" name="submit" class="btn btn-primary btn-block">Add Teacher</button>
      </form>
    </div>
